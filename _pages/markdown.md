...
* Profile image (can set in _config.yml): images/profile/profile.png
...
* The CV tab in this repo now embeds the PDF stored in `/files/Zac_Tobias_CV.pdf`. If you replace that file and rebuild, the `/cv/` page updates automatically.
